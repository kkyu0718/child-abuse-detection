...
class ConvLSTMCell(nn.Module):
    ...
    def forward(self, input_tensor, cur_state):
        ...
        # print('cur_state', np.shape(cur_state))
        ...
        import numpy as np
        # print('h_next is : ', np.shape(h_next) )
        # print('c_next is : ', np.shape(c_next ))
...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, num_layers,
        ...
        self.bias = bias #수정
        self.return_all_layers = return_all_layers #수정
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        if hidden_state is not None:
            ...
            hidden_state = self._init_hidden(batch_size=input_tensor.size(0), image_size =(input_tensor.size(3),input_tensor.size(4)) ,cuda=input_tensor.is_cuda)
        layer_output_list = []
        last_state_list = []
        ...
        if not self.return_all_layers:
            ...
            # import numpy as np
            # print('layer_output_list',np.shape(layer_output_list))
            # print('last_state_list',np.shape(last_state_list))
    ...
    def _init_hidden(self, batch_size,image_size, cuda):
        init_states = []
        ...
        import numpy as np
        # print('init_states : ', np.shape(init_states))
